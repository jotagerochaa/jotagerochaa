...
📚 Estou sempre em busca de novos desafios e aprendizados em tecnologias como HTML5, CSS, JavaScript, PHP, SQL, React Native, entre outras.

🎓 Atualmente curso o 3° ano em Técnico em Desenvolvimento de Sistemas (TDS) no Colégio Estadual Eron Domingues, onde incentivo e compartilho o interesse por programação com outros jovens.
